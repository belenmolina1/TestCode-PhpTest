...
<nav>
    <div class="d-flex justify-content-evenly" id="div-nav">
        ...
        <div class="container-fluid" id="btn-nav">
            <ul>
                <li><a
                        href="<?php echo base_url('/' . $locale . '/contact-list'); ?>"><?php echo lang('Validation.btn_contactList') ?></a>
                </li>
            </ul>
        </div>
</nav>
            ...
            <div class="row g-1 form-group">
                <div class="col-sm">
                    <input type="text" class="form-control icon name "
                        placeholder=" <?php echo lang('Validation.namePlaceholder') ?>" aria-label="Name" name="name">
                ...
                <div class="col-sm ">
                    <input type="text" class="form-control icon bday" id="datepicker"
                        placeholder=" <?php echo lang('Validation.bdayPlaceholder') ?>" aria-label="bday" name="bday"
                        max="2002-01-31">

                    <span id="error_bday" class="text-danger ms-2"></span>
                </div>
                <button type="button"
                    class="btn btn-danger ajax-send"><?php echo lang('Validation.btn_send') ?></button>
            </div>
    </div>
    <br />
