...
<nav>
    <div class="d-flex justify-content-evenly" id="div-nav">
        ...
        <div class="container-fluid" id="btn-nav">
            <ul>
                <li><a
                        href="<?php echo base_url('/' . $locale . '/contact-us'); ?>"><?php echo lang('Validation.btn_AddContact') ?></a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label><?php echo lang('Validation.modalTitleEdit') ?></label> <span id="error_name"
                        class="text-danger ms-2"></span>
                    <input type="text" id="name" class="form-control icon name" placeholder="Contact Name ..."
                ...
                <div class="form-group">
                    <label><?php echo lang('Validation.phonePlaceholder') ?></label> <span id="error_phone"
                        class="text-danger ms-2"></span>
                    <input type="text" class="form-control icon phone" placeholder=" Phone" aria-label="Phone"
                        name="phone" id="phone">
                </div>
                <div class="form-group">
                    <select
                        data-bind='style: { width: 180, height: 37, fontSize: 14},optionsCaption: "<?php echo lang('Validation.ctypeParr') ?>", options: availableCtype'
                        class="ctype" id="ctype"></select>
                ...
                <div class="form-group">
                    <label> <?php echo lang('Validation.bdayPlaceholder') ?></label> <span id="error_bday"
                        class="text-danger ms-2"></span>
                    <input type="text" class="form-control icon bday" id="datepicker" placeholder=" Birth Day"
                        aria-label="bday" name="bday" max="2002-01-31">
                </div>
            </div>
