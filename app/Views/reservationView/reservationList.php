...
<nav>
    <div class="d-flex justify-content-evenly" id="div-nav">
        ...
        <div class="container-fluid" id="btn-nav">
            <ul>
                <li><a
                        href="<?php echo base_url('/' . $locale . '/reservation'); ?>"><?php echo lang('Validation.btn_AddReserv') ?></a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label><?php echo lang('Validation.fullnamePlaceholder') ?></label> <span id="error_name"
                        class="text-danger ms-2"></span>
                    <input type="text" id="name" class="form-control icon name"
                        placeholder=" <?php echo lang('Validation.fullnamePlaceholder') ?>..." aria-label="Name"
                        name="name">
                </div>

                <div class="form-group">
                    <label><?php echo lang('Validation.phonePlaceholder') ?></label> <span id="error_phone"
                        class="text-danger ms-2"></span>
                    <input type="text" class="form-control icon phone"
                        placeholder=" <?php echo lang('Validation.phonePlaceholder') ?>" aria-label="Phone"
                        name="phone" id="phone">
                </div>
                <div class="form-group">
                    <select
                        data-bind='style: { width: 180, height: 37, fontSize: 14},optionsCaption: "<?php echo lang('Validation.rtypeParr') ?>", options: availableCtype'
                        class="rtype" id="rtype"></select>
                ...
                <div class="form-group">
                    <label><?php echo lang('Validation.rdatePlaceholder') ?></label> <span id="error_rdate"
                        class="text-danger ms-2"></span>
                    <input type="text" class="form-control icon rdate" id="datepicker"
                        placeholder=" <?php echo lang('Validation.rdatePlaceholder') ?>" aria-label="rdate"
                        name="rdate" min="2002-01-31">
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary"
                    data-bs-dismiss="modal"><?php echo lang('Validation.btn_close') ?></button>
                <button type="button" class="btn btn-danger"
                    id="delete_btnModal"><?php echo lang('Validation.btn_yes') ?></button>
            </div>
        </div>
    </div>
</div>
...
<div class="btn-group dropend">
    <button type="button" class="btn btn-secondary dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><img
            src='/TestCode/public/img/translate.svg'></button>
