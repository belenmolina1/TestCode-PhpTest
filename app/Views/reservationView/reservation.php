...
<nav>
    <div class="d-flex justify-content-evenly" id="div-nav">
        ...
        <div class="container-fluid" id="btn-nav">
            <ul>
                <li><a
                        href="<?php echo base_url('/' . $locale . '/reservation-list'); ?>"><?php echo lang('Validation.btn_reservList') ?></a>
                </li>
            </ul>
        </div>
</nav>
...
<section id="main-section">
    ...
    <div id="container-form" class="form-group">
        ...
        <div class="form-floating " id="editor">
            <input type="text" class="form-control icon description" id="description" aria-label="description"
                name="description">
        </div>
